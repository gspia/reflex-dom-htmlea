...
instance Monoid Area where
  mempty = defArea
  mappend (Area a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 a11 a12)
...
instance Monoid Audio where
  mempty = defAudio
  mappend (Audio a1 a2 a3 a4 a5 a6 a7 a8 a9)
...
instance Monoid Canvas where
  mempty = defCanvas
  mappend (Canvas a1 a2 a3 a4) (Canvas b1 b2 b3 b4)
...
instance Monoid IFrame where
  mempty = defIFrame
  mappend (IFrame a1 a2 a3 a4 a5 a6 a7) (IFrame b1 b2 b3 b4 b5 b6 b7)
...
instance Monoid Img where
  mempty = defImg
  mappend (Img a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 a11 a12)
...
instance Monoid Map where
  mempty = defMap
  mappend (Map a1 a2 a3) (Map b1 b2 b3) = Map (a1 <> b1) (a2 <> b2) (a3 <> b3)
...
instance Monoid Object where
  mempty = defObject
  mappend (Object a1 a2 a3 a4 a5 a6 a7 a8 a9)
...
instance Monoid Param where
  mempty = defParam
  mappend (Param a1 a2 a3 a4) (Param b1 b2 b3 b4)
...
instance Monoid Picture where
  mempty = defPicture
  mappend (Picture a1 a2) (Picture b1 b2) = Picture (a1 <> b1) (a2 <> b2)
...
instance Monoid Source where
  mempty = defSource
  mappend (Source a1 a2 a3 a4 a5 a6 a7) (Source b1 b2 b3 b4 b5 b6 b7)
...
instance Monoid Track where
  mempty = defTrack
  mappend (Track a1 a2 a3 a4 a5 a6 a7) (Track b1 b2 b3 b4 b5 b6 b7)
...
instance Monoid Video where
  mempty = defVideo
  mappend (Video a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 a11 a12)
