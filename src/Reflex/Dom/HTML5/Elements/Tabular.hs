...
eCaptionD' :: forall t m a. MonadWidget t m => Dynamic t ECaption -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eCaptionD' b = elDynAttr' "caption" (attrMap <$> b)

eCaptionD :: forall t m a. MonadWidget t m => Dynamic t ECaption -> m a -> m a
...
eColD' :: forall t m a. MonadWidget t m => Dynamic t ECol -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eColD' b = elDynAttr' "col" (attrMap <$> b)

eColD :: forall t m a. MonadWidget t m => Dynamic t ECol -> m a -> m a
...
eColGroupD' :: forall t m a. MonadWidget t m => Dynamic t EColGroup -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eColGroupD' b = elDynAttr' "colgroup" (attrMap <$> b)

eColGroupD :: forall t m a. MonadWidget t m => Dynamic t EColGroup -> m a -> m a
...
eTableD' :: forall t m a. MonadWidget t m => Dynamic t ETable -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eTableD' b = elDynAttr' "table" (attrMap <$> b)

eTableD :: forall t m a. MonadWidget t m => Dynamic t ETable -> m a -> m a
...
eTheadD' :: forall t m a. MonadWidget t m => Dynamic t EThead -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eTheadD' b = elDynAttr' "thead" (attrMap <$> b)

eTheadD :: forall t m a. MonadWidget t m => Dynamic t EThead -> m a -> m a
...
eTbodyD' :: forall t m a. MonadWidget t m => Dynamic t ETbody -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eTbodyD' b = elDynAttr' "tbody" (attrMap <$> b)

eTbodyD :: forall t m a. MonadWidget t m => Dynamic t ETbody -> m a -> m a
...
eTfootD' :: forall t m a. MonadWidget t m => Dynamic t ETfoot -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eTfootD' b = elDynAttr' "tfoot" (attrMap <$> b)

eTfootD :: forall t m a. MonadWidget t m => Dynamic t ETfoot -> m a -> m a
...
eTrD' :: forall t m a. MonadWidget t m => Dynamic t ETr -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eTrD' b = elDynAttr' "tr" (attrMap <$> b)

eTrD :: forall t m a. MonadWidget t m => Dynamic t ETr -> m a -> m a
...
eThD' :: forall t m a. MonadWidget t m => Dynamic t ETh -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eThD' b = elDynAttr' "th" (attrMap <$> b)

eThD :: forall t m a. MonadWidget t m => Dynamic t ETh -> m a -> m a
...
eTdD' :: forall t m a. MonadWidget t m => Dynamic t ETd -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
