...
eArticleD' :: forall t m a. MonadWidget t m => Dynamic t EArticle -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eArticleD' b = elDynAttr' "article" (attrMap <$> b)

eArticleD :: forall t m a. MonadWidget t m => Dynamic t EArticle -> m a -> m a
...
eAsideD' :: forall t m a. MonadWidget t m => Dynamic t EAside -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eAsideD' b = elDynAttr' "aside" (attrMap <$> b)

eAsideD :: forall t m a. MonadWidget t m => Dynamic t EAside -> m a -> m a
...
eNavD' :: forall t m a. MonadWidget t m => Dynamic t ENav -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eNavD' b  = elDynAttr' "nav" (attrMap <$> b)

eNavD :: forall t m a. MonadWidget t m => Dynamic t ENav -> m a -> m a
...
eSectionD' :: forall t m a. MonadWidget t m => Dynamic t ESection -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eSectionD' b  = elDynAttr' "section" (attrMap <$> b)

eSectionD :: forall t m a. MonadWidget t m => Dynamic t ESection -> m a -> m a
...
eH1D' :: forall t m a. MonadWidget t m => Dynamic t EH1 -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eH1D' b  = elDynAttr' "h1" (attrMap <$> b)

eH1D :: forall t m a. MonadWidget t m => Dynamic t EH1 -> m a -> m a
...
eH2D' :: forall t m a. MonadWidget t m => Dynamic t EH2 -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eH2D' b  = elDynAttr' "h2" (attrMap <$> b)

eH2D :: forall t m a. MonadWidget t m => Dynamic t EH2 -> m a -> m a
...
eH3D' :: forall t m a. MonadWidget t m => Dynamic t EH3 -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eH3D' b  = elDynAttr' "h3" (attrMap <$> b)

eH3D :: forall t m a. MonadWidget t m => Dynamic t EH3 -> m a -> m a
...
eH4D' :: forall t m a. MonadWidget t m => Dynamic t EH4 -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eH4D' b  = elDynAttr' "h4" (attrMap <$> b)

eH4D :: forall t m a. MonadWidget t m => Dynamic t EH4 -> m a -> m a
...
eH5D' :: forall t m a. MonadWidget t m => Dynamic t EH5 -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eH5D' b  = elDynAttr' "h5" (attrMap <$> b)

eH5D :: forall t m a. MonadWidget t m => Dynamic t EH5 -> m a -> m a
...
eH6D' :: forall t m a. MonadWidget t m => Dynamic t EH6 -> m a -> m (Element EventResult (DomBuilderSpace m) t, a)
eH6D' b  = elDynAttr' "h6" (attrMap <$> b)

eH6D :: forall t m a. MonadWidget t m => Dynamic t EH6 -> m a -> m a
